...
import easyocr
import re ## to search and manipulate text patterns
from datetime import datetime ## help in working with dates
from dateutil import parser ### convert dates to strings & in general work with dates in a proper format
from dateutil.relativedelta import relativedelta ### adding or subtracting specific time units
import spacy ### for text processing tasks
...
def extract_text_from_image(image_path):
    reader = easyocr.Reader(['en']) ### suports over 80 languages
...
def calculate_years_of_experience(text):
    ...
    total_duration = relativedelta() ### empty date object
